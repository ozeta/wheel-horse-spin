...
2. Default number of players defined by a constant. let the initial value be 2. Max number of player will be 6.
3. game mechanic:
    ...
    I want to have always 10 players. there will be 10 - X bot players, where X is the number of human players. For the bot reuse the speed function from the current game.
